...
const GestionarMantenimiento = () => {  
  ...
  const cargarInventarios = async () => {  
    try {  
      ...
      showError('Error al cargar inventarios');  
    }  
  };  
  ...
  const handleEliminar = async (id) => {  
    if (window.confirm('¿Está seguro de eliminar este mantenimiento?')) {  
      try {  
        ...
        setMantenimientos(mantenimientos.filter(m => m.idMantenimiento !== id));  
                ...
                <Form>  
                  <Row>  
                    ...
                    <Col md="2" className="d-flex align-items-end">  
                      <FormGroup>  
                        <Button color="info" onClick={aplicarFiltros} className="mr-2">  
                          Filtrar  
                        </Button>  
                ...
                <Table className="align-items-center table-flush" responsive>  
                  ...
                  <tbody>  
                    {loading ? (  
                      ...
                      <tr>  
                        <td colSpan="8" className="text-center">No hay mantenimientos registrados</td>  
                      </tr>  
                    ) : (  
                      mantenimientos.map(mantenimiento => (  
                        <tr key={mantenimiento.idMantenimiento}>  
                          ...
                          <td>  
                            {mantenimiento.InventarioModel ?   
                              `${mantenimiento.InventarioModel.codigo} - ${mantenimiento.InventarioModel.nombre}` :   
                              'N/A'  
                            }  
                          </td>  
