...
// Relaciones existentes con Cliente y Empleado  
...
// NUEVAS relaciones con Factura (importar aquí para evitar dependencia circular)  
const Factura = require('../facturacion/Factura');  
  
// Una orden puede tener múltiples facturas  
OrdenPublicidad.hasMany(Factura, {   
  foreignKey: 'idOrdenPublicidad',  
  as: 'facturas'  
});  
  
// Una factura pertenece a una orden (opcional)  
